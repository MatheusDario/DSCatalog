...
public class ProductResourceTests {
	...
	public void findByIdShouldReturnProductDTOWhenIdExists() throws Exception {
		mockMvc.perform(get("/products/{id}", existingId).accept(MediaType.APPLICATION_JSON))
				...
				.andExpect(jsonPath("$.description").exists()).andExpect(status().isOk());
	}
	...
	@Test
	public void insertShouldReturnInsertProductDTO() throws Exception {
	...
	@Test
	public void deleteShouldReturnNoCountentWhendIdExists() throws Exception {
		mockMvc.perform(delete("/products/{id}", existingId)).andExpect(status().isNoContent());
	}
	
	@Test
	public void deleteShouldReturnNoFoundWhendIdDoesNotExists() throws Exception {
